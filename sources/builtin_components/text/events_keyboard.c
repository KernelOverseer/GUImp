...
static int     focus(t_libui_component *text,
    SDL_Event *e)
{
    (void)text;
    (void)e;
    text->status.focused = TRUE;
    return (1);
}

static int     lose_focus(t_libui_component *text,
    SDL_Event *e)
{
    (void)text;
    (void)e;
    text->status.focused = FALSE;
    return (1);
}
static int     key_down(t_libui_component *text,
    SDL_Event *e)
{
    (void)text;
    (void)e;
...
static int     key_up(t_libui_component *text,
    SDL_Event *e)
{
    (void)text;
    (void)e;
